...
export default class MainPage extends React.Component{
    ...
    removeItem(event,item){
      ...
      let stateItems=this.state.items;
        ...
        let finalPrice=0;
        let shipping=false;
        let index=stateItems.findIndex((itemvalue) => itemvalue.product === item.product);
        ...
        this.setState({items:stateItems,subTotal:subTotal,finalPrice:finalPrice,shipping:shipping});
      ...
      return(
        <div style={{height:"130px"}}>
          <AppBar position="position">
            ...
            <h4 align="left" >If the cart is completely empty then we shall again add back products for you</h4>
          </AppBar>
        </div>
      )
    }
    ...
    displayProducts(){
        return (
              ...
              {this.state.items.map(item => (
                <TableRow key={item.product}>
                  <TableCell component="th" scope="row">
                    <span style={{display: "inline",width:"100px"}}>
                    ...
                    <span style={{display: "inline"}}>
                       ...
                       <span>
                          <Link href="#" style={{display:"inline"}} onClick={(e)=>this.editItems(e,item)}>
                              Edit
                          </Link>
                          <br></br>
                          <Link href="#" style={{display:"inline"}} onClick={(e)=>this.removeItem(e,item)}>
                              Remove
                          </Link>
                  ...
                  <TableCell align="right"><input type="number" value={item.qty} style={{width:"50px"}}
                  onChange={(e)=>this.handleQuantityChange(e,item.product)}></input></TableCell>
           ...
           <TableCell rowSpan={1} />
            ...
            <TableCell  align="right"><input type="text" value={this.state.discountCode} onChange={(e) => this.discountOnChange(e)}></input></TableCell>
            {/* <TableCell colSpan={1} /> */}
            <TableCell><Button align="right"
          ...
          <TableRow>
            <TableCell>ESTIMATED SHIPPING*</TableCell>
              <TableCell align="right">{}</TableCell>
            <TableCell align="right">{this.state.shipping?"FREE":"50"}</TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell colSpan={2} align={"right"}>Continue Shopping</TableCell>
      ...
      return(
        <div>
          <Dialog
                ...
                <DialogContent >
                    <img src={this.state.selectedItemEdit.url}  style={{width:"75px",height:"75px"}}/>
                </DialogContent>
                <DialogActions>
                    <Button
